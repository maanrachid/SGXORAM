...
void encrypt_wolfssl(Block message[], int size,int op,long long IV_counter){
  Aes enc;
  int ret = 0;
...
void encrypt_ipp(Block message[], int size,int op,long long IV_counter){
...
void Encrypt(Block message[], int size,int op,long long IV_counter){
